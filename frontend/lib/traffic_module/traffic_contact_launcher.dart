...
class TrafficContactLauncher {
  ...
  static Future<void> dial(BuildContext context, String numberDigits) async {
    ...
    await _launch(context, uri, errorMessage: loc.cannotStartCall);
  }
  ...
  static Future<void> whatsAppComplaint(BuildContext context) async {
    ...
    await _launch(context, Uri.parse('https://wa.me/$phone?text=$text'));
  }
  ...
  static Future<void> openMapsSearch(BuildContext context, String query) async {
