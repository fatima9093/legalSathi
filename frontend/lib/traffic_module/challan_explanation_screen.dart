                    ...
                    onPressed: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute<void>(
                          builder: (context) =>
                              ChallanPayOnlineScreen(challanData: challanData),
                        ),
                      );
                    },
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 12),
          ...challanData.paymentOptions.map(
            (option) => _buildBulletPoint(option),
          ),
          const SizedBox(height: 16),
          Row(
            children: [
