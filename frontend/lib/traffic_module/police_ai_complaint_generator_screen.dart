...
class _PoliceAIComplaintGeneratorScreenState
    ...
    if (isGuest && mounted) {
      showDialog(
        ...
        builder: (context) => AlertDialog(
          ...
          content: const Text(
            'Filing traffic complaints requires an account to safely store your information and track your case. Please sign in to continue.',
          ),
          actions: [
            TextButton(
  ...
  Future<void> _generateComplaint() async {
    ...
    if (!Validators.isNonEmpty(_whereController.text)) {
      Validators.showError(context, loc.enterLocation);
      return;
    }
    ...
    if (saveResult['success'] == true) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(saveResult['message'] as String? ?? 'Done'),
    ...
    final resolvedId =
        saveResult['id'] as String? ?? widget.existingComplaintId;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          _isEditing ? loc.editComplaint : loc.aiComplaintGenerator,
