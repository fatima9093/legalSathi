...
class _FIAComplaintGeneratorScreenState
    ...
    if (isGuest && mounted) {
      showDialog(
        ...
        builder: (context) => AlertDialog(
          ...
          content: const Text(
            'Filing cyber crime complaints requires an account to safely store your information and track your case. Please sign in to continue.',
          ),
          actions: [
            TextButton(
  ...
  Future<void> _generateComplaint() async {
    ...
    if (!(saveResult['success'] as bool? ?? false)) {
      Validators.showError(context, saveResult['message'] ?? loc.errorSaving);
      return;
    }
