...
import '../labour_rights_module/file_general_complaint_screen.dart';
...
''';
      ...
      _relevantLaws =
          widget.relevantLaws ?? ['Consult legal authority for verification'];
  ...
  void _generateComplaint() {
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) =>
            FileGeneralComplaintScreen(complaintIssue: issue.toString()),
      ),
    );
  }
