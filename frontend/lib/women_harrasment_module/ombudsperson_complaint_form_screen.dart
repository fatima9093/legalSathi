...
import 'package:front_end/women_harrasment_module/incident_details_screen.dart';
  ...
  Future<void> _saveAndContinue() async {
    ...
    if (result['success']) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(loc.infoSaved), backgroundColor: Colors.green),
      );
      ...
      Navigator.push(
        ...
        MaterialPageRoute(
          builder: (context) => IncidentDetailsScreen(
            ...
            department: _cityController.text,
          ),
        ),
      );
    } else {
