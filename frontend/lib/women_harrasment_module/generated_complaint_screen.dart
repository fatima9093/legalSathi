  ...
  void _regenerateComplaint(BuildContext context) {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: Text(loc.regenerateComplaint),
        content: Text(loc.regenerateConfirm),
        actions: [
          TextButton(
