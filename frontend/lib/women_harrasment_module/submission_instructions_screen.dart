  ...
  Future<void> _downloadPDF() async {
    ...
    if (isGuest && mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Sign in to download and save documents'),
    ...
    if (isGuest && mounted) {
      showDialog(
        ...
        builder: (context) => AlertDialog(
          ...
          content: const Text(
            'Submitting complaints requires an account to track your request and maintain your privacy. Please sign in to proceed.',
          ),
          actions: [
            TextButton(
    ...
    if (result['success']) {
      showDialog(
        ...
        builder: (context) => AlertDialog(
          ...
          content: Text(loc.complaintSubmittedMsg),
          actions: [
            ElevatedButton(
              onPressed: () {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildSubmissionMethod(
                      ...
                      description: loc.emailSubmissionDesc,
                    ),
                    ...
                    _buildSubmissionMethod(
                      ...
                      description: loc.onlinePortalDesc,
                    ),
