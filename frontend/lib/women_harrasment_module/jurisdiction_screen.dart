...
import 'package:front_end/women_harrasment_module/ombudsperson_complaint_form_screen.dart';
...
class _SelectJurisdictionScreenState extends State<SelectJurisdictionScreen> {
  ...
  final List<Map<String, String>> jurisdictions = [
    {'name': 'Punjab', 'urdu': 'پنجاب'},
    {'name': 'Sindh', 'urdu': 'سندھ'},
    {'name': 'Khyber Pakhtunkhwa', 'urdu': 'خیبرپختونخوا'},
    {'name': 'Balochistan', 'urdu': 'بلوچستان'},
    {'name': 'Islamabad Capital Territory', 'urdu': 'اسلام آباد'},
    {'name': 'Federal Government', 'urdu': 'وفاقی حکومت'},
  ];
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            // Title
            Text(
              AppLocalizations.of(context)!.whichProvince,
              style: TextStyle(
                fontSize: 20,
            ...
            // Subtitle
            Text(
              AppLocalizations.of(context)!.selectWorkplaceLocation,
        ...
        child: ElevatedButton(
          onPressed: selectedJurisdiction != null
              ? () {
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          const OmbudspersonComplaintFormScreen(),
                    ),
                  );
          ...
          child: Text(
            ...
            style: TextStyle(
              fontSize: 16,
              fontWeight: FontWeight.w600,
              color: selectedJurisdiction != null
                  ? Colors.white
