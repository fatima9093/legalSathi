      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              result['message'] ??
                  AppLocalizations.of(context)!.failedToLoadComplaint,
            ),
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildSection(
                            AppLocalizations.of(context)!.applicantDetails,
                            [
                          ...
                          _buildSection(
                            AppLocalizations.of(context)!.accusedPerson,
                            [
                          ...
                          if (_complaint!.evidenceFiles != null &&
                            ...
                            _buildSection(
                              AppLocalizations.of(context)!.evidenceFiles,
                              [
            ...
            child: Column(
              children: [
                ElevatedButton(
                  ...
                  child: Text(
                    AppLocalizations.of(context)!.continueToSubmission,
                    style: TextStyle(
                      fontSize: 16,
                      fontWeight: FontWeight.w600,
                      color: Colors.white,
