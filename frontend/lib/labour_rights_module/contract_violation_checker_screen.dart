...
class _ContractViolationCheckerScreenState
          ...
          if (_pickedFileName != null) ...[
            ...
            Container(
              ...
              child: Row(
                children: [
                  Icon(
                    _pickedKind == 'pdf' ? Icons.picture_as_pdf : Icons.image,
              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    hintText:
                        'Paste your employment contract or key clauses here…',
                    hintStyle: TextStyle(
                      fontSize: 13,
  ...
  Widget _buildResultView() {
    ...
    final riskColor = compliant
        ? const Color(0xFF2E7D32)
        : Colors.orange.shade800;
    final riskLabel = compliant
        ? 'Looks broadly compliant'
        : 'Review recommended';
                    ...
                    Row(
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color: severityIconColor.withValues(alpha: 0.1),
